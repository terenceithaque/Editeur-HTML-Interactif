...
class Application(Tk):
    ...
    def __init__(self):
        ...
        self.menu_ajouter.add_command(label="Titre de la page...", command=None) # Permettre à l'utilisateur de spécifier le titre de la page
        self.menu_ajouter.add_command(label="Image...", command=None) # Permettre à l'utilisateur d'insérer une image
        self.menu_ajouter.add_command(label="Texte...", command = None) # Permettre à l'utilisateur d'insérer du texte
